...
const getFullNames = (arr) => {
  const fullNames = [];
  for (let user of arr) {
    // Use template literals to concatenate first and last name
    fullNames.push(`${user.firstName} ${user.lastName}`);
  }
  return fullNames;
};

const fullNames = getFullNames(usersArray);
console.log(fullNames); // expected output: ["Kirby Doyle", "Tracie May", ...]
